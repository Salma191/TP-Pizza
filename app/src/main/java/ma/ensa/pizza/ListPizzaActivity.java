...
import ma.ensa.pizza.service.ProduitService;
    ...
    public class ListPizzaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // Configurez l'adaptateur pour votre ListView
            PizzaAdapter pizzaAdapter = new PizzaAdapter(this, ps.findAll());
            liste.setAdapter(pizzaAdapter);
